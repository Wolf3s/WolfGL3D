...
#define TILE_IS_SOLIDTILE (TILE_IS_WALL | TILE_IS_BLOCK)
#define TILE_BLOCKS_MOVE	(TILE_IS_WALL | TILE_IS_BLOCK | TILE_IS_ACTOR)
...
// for now it is just an index of texture (0-based) in
// swap file (n*2+1) - what to draw!
	int wall_tex[64][64];
...
extern int Lvl_LoadLevel(int n);
