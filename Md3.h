...
public:
	...
	float ScaleX, ScaleY, ScaleZ; //added by Idot
	float X,Y,Z; //added by Idot
	short int Skins;//added by Idot: skins number

	int D; //added by Idot, D means direction (an orienattion of the model)
	...
	bool LoadModel(const LPSTR strPath, const LPSTR strModel, const LPSTR Skin);
		//Deatilzation postfix & Skin postfix	
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
	...
	void DrawModel(const int LOD, const int skin=0);//modified by Idot
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
	...
	void DrawLink(t3DModel *pModel, t3DModel *pSkin);

	// This a md3 model to the screen (not the whole character)
	void RenderModel(t3DModel *pModel, t3DModel *pSkin);
...
//	t3DModel m_Upper;
//	t3DModel m_Lower;
	t3DModel m_model[4];//modified by Idot: 0-low, 1-mid, 2-high, 3-reserved for ultra-res
	t3DModel m_skins[8];//made by Idot: up to 8 skins per model
